...
import type { ProfilePublic as _ProfilePublic, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addGoal(arg0: Goal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteWorkout(arg0: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getCallerUserProfile(): Promise<ProfilePublic> {
        if (this.processError) {
            try {
    ...
    async getGoals(): Promise<PublicGoals> {
        if (this.processError) {
            try {
    ...
    async getUserProfile(arg0: Principal): Promise<ProfilePublic | null> {
        if (this.processError) {
            try {
    ...
    async getWorkout(arg0: number): Promise<Workout> {
        if (this.processError) {
            try {
    ...
    async logWorkout(arg0: Workout): Promise<number> {
        if (this.processError) {
            try {
    ...
    async saveCallerUserProfile(arg0: ProfilePublic): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateGoal(arg0: string, arg1: number): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProfilePublic]): ProfilePublic | null {
